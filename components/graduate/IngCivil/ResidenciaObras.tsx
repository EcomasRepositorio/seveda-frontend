...
import { moduleResidenciaSupervicionObras } from "@/components/utils/courses/course";
          ...
          {isAccordionOpen1 && (
            <motion.div
              ...
              <div className="text-sm font-sans font-semibold">
                <ul className="">
                  {moduleResidenciaSupervicionObras.map((item, index) => (
                    <motion.li
                      key={index}
                      initial={{ opacity: 0 }}
                      animate={{
...
export default ResidenciaObras;
