...
import { moduleAsistenteTecnicoObras } from "@/components/utils/courses/course";
      ...
      <div className="grid md:grid-cols-2 grid-cols-1">
        <div className="flex justify-center mb-4 md:mb-0">
          <Image
            ...
            width={400}
            height={300}
            className="md:h-[410px] md:w-[400px] rounded-2xl"/>
        </div>
        ...
        <div className="">
          ...
          <div className="grid justify-between gap-4 md:grid-cols-2 grid-cols-1">
            <Link
              ...
              href="https://wa.me/51961646248?text=Hola,%20deseo%20más%20información%20sobre%20el%20diplomado%20de%20Asistente%20técnico%20de%20obras"
              target="_blank">
                Más información
          ...
          {isAccordionOpen1 && (
            <motion.div
              ...
              <div className="text-sm font-sans font-semibold">
                <ul className="">
                  {moduleAsistenteTecnicoObras.map((item, index) => (
                    <motion.li
                      key={index}
                      initial={{ opacity: 0 }}
                      animate={{
