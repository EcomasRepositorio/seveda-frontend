...
import { moduleEstudioAmbiental } from "@/components/utils/courses/course";
    ...
    <div className="">
      ...
      <div className="grid md:grid-cols-2 grid-cols-1">
        <div className="flex justify-center mb-4 md:mb-0">
          <Image
            src="/graduate/estudio-de-impacto-ambiental.png"
            alt="Descripción de la imagen 1"
            width={400}
            height={300}
            className="h-[420px] w-[400px] rounded-2xl"/>
        </div>
        ...
        <div className="">
          ...
          <div className="grid justify-between gap-4 md:grid-cols-2 grid-cols-1">
            <Link
              ...
              href="https://wa.me/51961646248?text=Hola,%20deseo%20más%20información%20sobre%20el%20diplomado%20de%20Estudio%20de%20Impacto%20Ambiental"
              target="_blank">
                Más información
          ...
          {isAccordionOpen1 && (
            <motion.div
              ...
              <div className="text-sm font-sans font-semibold">
                <ul className="">
                  {moduleEstudioAmbiental.map((item, index) => (
                    <motion.li
                      key={index}
                      initial={{ opacity: 0 }}
                      animate={{
...
export default EstudioAmbiental;
